          ...
          {item.id &&
            <Accordion>
              ...
              <AccordionDetails className={classes.details}>
                <LinkField
                  margin="normal"
                  endpointAll={backend.backend+"/api/devices?all=true"}
                  endpointLinked={backend.backend+"/api/devices?userId=" + item.id}
                  baseId={item.id}
                  keyBase="userId"
                  keyLink="deviceId"
                  label={t('deviceTitle')}
                ...
                <LinkField
                  margin="normal"
                  endpointAll={backend.backend+"/api/groups?all=true"}
                  endpointLinked={backend.backend+"/api/groups?userId=" + item.id}
                  baseId={item.id}
                  keyBase="userId"
                  keyLink="groupId"
